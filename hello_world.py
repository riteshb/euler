...
if __name__ == '__main__':
    try:
        ...
        parser.add_option('-l', '--list', dest="numbers", help='comma separated list of numbers')
        parser.add_option('-s', '--size', dest="size_matrix", help='size of matrix size_matrixXsize_matrix')
